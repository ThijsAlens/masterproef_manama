...
\makeatletter% required keep
Title Master thesis: \@title \hspace{1cm} Promoter: \underline{Prof Dr M. Verbeke}\\
Daily supervisor: \underline{Dr Ir L. Devos}
\makeatother
...
\begin{itemize}
    ...
    \item[$\boxtimes$] I did use GenAI assistance. In this case, specify which ones (e.g., ChatGPT, \ldots): \underline{Gemini}
\end{itemize}
