...
\title{Safety mechanisms for vision-based object localization for robot grasping}
...
\promotorA[Supervisor(s)]{Mathias Verbeke\\Laurens Devos} %for English use Supervisor(s)
