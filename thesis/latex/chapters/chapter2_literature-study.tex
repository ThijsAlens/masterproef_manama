...
Finally, we will dive into different existing methods to make \gls{ai} models uncertainty-aware and discuss how their ideas can be applied to a regression problem.
...
This will be further discussed in \cref{ch:dataset_section:labeling}.
