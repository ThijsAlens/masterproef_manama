...
Even more, they will fix themselfs if the models are trained properly.
...
This translation has a lot of opportunities for errors, which can cause a lot of uncertainty in the final output of the model, uncertainty the model does not account for.
...
Models who can handle / quantify the uncertainties as described in~\ref{ch:literature-study_section:uncertainty-in-ai} are very sought-after in safety-critical applications like robot arm grasping.
