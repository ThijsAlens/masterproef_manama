...
\ref{fig:overfitting} shows an example of a model which is not well generalized, and thus captures the noise in the data, leading to a high aleatoric uncertainty.
