...
% While these new technologies bring many advantages, they also introduce new challenges.
% For example, robots are often designed to operate in structured and controlled environments, falling short when faced with dynamic and unpredictable settings, which are not uncommon in real-world scenarios.
% When operating in such environments, robots need to be able to adapt to changes, or at least be able to detect them and inform a human operator.
...
\todo{Nog iets over uncertainty AI}
