...
We thus would need to do manually move the robot to the correct location for each data point.

This takes a lot of time and introduces some human error and is not that consistent, so we opted against using the robot's position as labels for the dataset.
