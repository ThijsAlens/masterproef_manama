...
SQUARE_SIZE_M = 0.0253      # Size of a square in your defined unit (here meters)

CALIBRATION_IMAGE_PATH = "calibration/checkerboard.png"                         # Path to the calibration image file
CALIBRATION_T_MATRIX_FILEPATH = "calibration/camera_calibration_matrix.npy"     # Path to save/load the camera calibration matrix
