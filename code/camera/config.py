...
EXCLUDE_MEASURING_X = (100, 470)  # Cropping range for the x-axis to exclude measuring lines
EXCLUDE_MEASURING_Y = (40, 290)  # Cropping range for the y-axis to exclude measuring lines
...
CALIBRATION_MAPPING_FILEPATH = "camera/calibration_map.json"  # Path to save/load the pixel-to-real-world mapping
...
DISTANCE_BETWEEN_LINES_MM = 20 # Real-world distance between the lines in millimeters (used for scaling)